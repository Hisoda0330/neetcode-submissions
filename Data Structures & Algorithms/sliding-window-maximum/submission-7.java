    ...
    public int[] maxSlidingWindow(int[] nums, int k) {
        ...
        */
        ...
        for(int right = 0; right < nums.length; right++){
            //update deque so first is always largest 
            ...
            //update res as window size matches
            if(right - left + 1 == k){
...
//deque is a double ended queue -> can modify last / front items.
//how to record the result in the correct index?
//window size ==  k? -> update resindex each time.
