...
1. find the largest value in arr for the initial k
2. use binary search on the initial k to find the min k. by:
compare each k of total ceil(double(i) / mid) to find the min k.
