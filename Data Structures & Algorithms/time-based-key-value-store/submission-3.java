...
//An interface defines a type and its required behavior; a class implements that interface and creates objects of a concrete type.
//core idea: understand the class, list(interface), hashmap(class), map(interface), and arraylist(class) in java and use standard binary search.
